...
PROFESSIONAL_THEME = """
QWidget { background-color: #000000; color: #ffffff; font-family: 'Segoe UI', sans-serif; }
QFrame#SideBar { background-color: #1c1c1e; border-right: 1px solid #333; }
QListWidget { background-color: #1c1c1e; color: white; border: none; font-size: 16px; padding: 10px; }
QListWidget::item { padding: 8px; border-radius: 6px; }
QListWidget::item:selected { background-color: #0a84ff; }
QLabel { color: white; }
QLabel#Header { font-size: 20px; font-weight: bold; color: #0a84ff; padding: 10px; }
QLabel#Instruction { font-size: 28px; font-weight: bold; color: #fff; }
QLineEdit { background-color: #2c2c2e; color: white; padding: 12px; border: 1px solid #3a3a3c; border-radius: 8px; font-size: 16px; }
QPushButton { background-color: #3a3a3c; color: white; padding: 12px; border-radius: 8px; font-weight: bold; border: none; font-size: 14px; }
QPushButton:hover { background-color: #48484a; }
QPushButton#PrimaryBtn { background-color: #0a84ff; }
QPushButton#PrimaryBtn:hover { background-color: #007aff; }
QPushButton#DeleteBtn { background-color: #ff453a; }
QPushButton#DeleteBtn:hover { background-color: #ff3b30; }
QProgressBar { border: none; background-color: #2c2c2e; border-radius: 4px; height: 8px; }
QProgressBar::chunk { background-color: #30d158; border-radius: 4px; }
QComboBox { background-color: #2c2c2e; color: white; padding: 8px; border: 1px solid #3a3a3c; border-radius: 6px; min-width: 150px; }
...
class AdminApp(QWidget):
    ...
    def init_ui(self):
        ...
        self.cam_lbl.setStyleSheet("background: #000; border-radius: 20px;")
